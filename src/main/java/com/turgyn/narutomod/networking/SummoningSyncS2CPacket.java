...
public class SummoningSyncS2CPacket {
	private final int senjutsu;

	public SummoningSyncS2CPacket(int senjutsu) {
		this.senjutsu = senjutsu;
	}

	public SummoningSyncS2CPacket(FriendlyByteBuf buf) {
	...
	public void handle(Supplier<NetworkEvent.Context> supplier) {
		...
		context.enqueueWork(() -> PlayerData.setSummoning(senjutsu));
	}
}
