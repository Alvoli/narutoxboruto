...
import com.turgyn.narutomod.networking.ShurikenjutsuSyncS2CPacket;
...
public class Shurikenjutsu {
	...
	public void syncValue(ServerPlayer serverPlayer) {
		ModPacketHandler.sendToPlayer(new ShurikenjutsuSyncS2CPacket(this.value), serverPlayer);
	}
	...
	public void saveNBTData(CompoundTag nbt) {
		nbt.putInt("shurikenjutsu", value);
	}

	public void loadNBTData(CompoundTag nbt) {
		value = nbt.getInt("shurikenjutsu");
	}
}