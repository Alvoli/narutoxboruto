...
import com.turgyn.narutomod.networking.KenjutsuSyncS2CPacket;
...
public class Kenjutsu {
	...
	public void syncValue(ServerPlayer serverPlayer) {
		ModPacketHandler.sendToPlayer(new KenjutsuSyncS2CPacket(this.value), serverPlayer);
	}
	...
	public void saveNBTData(CompoundTag nbt) {
		nbt.putInt("kenjutsu", value);
	}

	public void loadNBTData(CompoundTag nbt) {
		value = nbt.getInt("kenjutsu");
	}
}